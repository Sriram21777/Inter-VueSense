...
#! This file contains the database connection and initialization of db.
...
class Mongo:
    def __init__(self, db_name, init_function = None):
        ...
        self.db = pymongo.MongoClient("mongodb+srv://lit2021001:sreX58LgM9RXTzTn@cluster0.dzvmofn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")[db_name]
