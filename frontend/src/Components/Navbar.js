        ...
        <div style={{position:'relative', zIndex:5}}>
            <div className='navbar-custom'>
                <div className='navbar-logo' onClick={() => { navigate('/', { replace: true }) }}>
                    <span style={{ fontSize: '1.6rem', color: '#411D7A', fontWeight: "bold" }}>InterV<span style={{ fontSize: '1.4rem', fontWeight: 'normal' }}>ue</span><span style={{ fontSize: '1.4rem', fontWeight: 'bold' }}>Sense</span></span>
                </div>
